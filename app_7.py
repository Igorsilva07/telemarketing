...
st.set_page_config(
    ...
    page_icon = 'telmarketing_icon.png', # Ensure this image is in the same directory as your app_7.py
    layout="wide",
...
# --- FIX 2: Update st.cache to st.cache_data ---
# Função para ler os dados
@st.cache_data(show_spinner= True) # Use st.cache_data for data loading
...
@st.cache_data() # Use st.cache_data for data filtering
...
@st.cache_data() # Use st.cache_data for data conversion
def convert_df(df):
...
def to_excel(df):
    ...
    writer.close() # Use .close() for pandas >= 1.3, .save() is deprecated
...
def main():
    ...
    # Certifique-se de que 'Bank-Branding.jpg' está na mesma pasta que seu app_7.py
